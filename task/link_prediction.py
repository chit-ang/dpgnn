...
def write_to_csv(test_results, output_name, model_name, dataset, mod='val'):
    with open(output_name, 'a+') as f:
        for op in test_results:
            best_auc = test_results[op]
            f.write("{},{},{},{},{},{}\n".format(dataset, model_name, op, mod, "AUC", best_auc))
...
def evaluate_classifier(train_pos, train_neg, val_pos, val_neg,test_pos, test_neg, source_embeds, target_embeds):
    ...
    return val_results, val_pred_true,test_results, test_pred_true
