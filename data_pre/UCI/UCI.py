...
with open('opsahl-ucsocial.edges') as f:
...
np.savez('D:/git/LDP-DG/data/UCI/graphs.npz', graph=slices_links_remap)
np.savez('D:/git/LDP-DG/data/UCI/features.npz', feats=slices_features_remap)